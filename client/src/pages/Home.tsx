...
export default function Home() {
  ...
  return <div className="app-shell">
    ...
    <main>
      <section className="hero" aria-labelledby="page-title"><div><span className="section-kicker">Coastal image review</span><h1 id="page-title">Detect litter in a shoreline photo.</h1><p>Upload a coastal image and this tool runs a YOLO26s model trained on marine litter, then shows you the bounding boxes and confidence scores for what it found.</p></div></section>
